    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div ref={exportRef} style={styles.page}>
        ...
        {policy.policy_draft && (
          <div style={styles.pageBreak}>
            <div style={styles.section}>
              <div style={styles.sectionTitle}>3b. AI Policy Charter</div>
              <div style={{ fontSize: '10px', color: '#6b7280', marginBottom: '12px', fontStyle: 'italic' }}>
                Generated by the DIVE Policy Builder — based on the Sorbonne Paris 1 charter (2025), UNamur research (Coumont, 2025), and Vietnam MoET guidelines (2026).
              </div>
              <div style={{ fontSize: '10px', color: '#1f2937', lineHeight: '1.6', whiteSpace: 'pre-wrap', padding: '12px', background: '#f9fafb', borderRadius: '6px', border: '1px solid #e5e7eb' }}>
                {policy.policy_draft}
              </div>
            </div>
          </div>
